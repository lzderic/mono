  ...
  return (
    <main className="container font-text">
      ...
      <div className={store.LayoutStore.layout}>
        <ListOfItems service={store.RootStore.ModelService} pagination={store.PaginationStore} filter={store.filterListByName(store.RootStore.ModelService.VehicleModel, store.FilteredListStore.searchTerm)} link={"vehiclemodel/update/"}/>
      </div>
